...
require (
	...
	golang.org/x/text v0.34.0 // indirect; sindirect
...
replace github.com/longhorn/go-spdk-helper => github.com/linkpoolio/go-spdk-helper v0.6.1-0.20260706135231-2457f6714c55

...
// Options for nvmf_create_transport.
//
//   - MaxQueueDepth=128 is the SPDK upstream default and gives the headroom
//     needed for high-IOPS workloads.
//   - DataWrPoolSize=4095 is critical for RDMA: SPDK's default of 0 forces
//     per-qpair RDMA WR allocation on every submission, which caps throughput
//     at hundreds of KB/s.
//   - IoUnitSize=8192 is the SPDK-defined RDMA minimum; SPDK chains larger
//     I/Os. MaxIoSize=131072 matches the kernel initiator's max_hw_sectors_kb.
//   - TCP options match SPDK upstream defaults.
var (
